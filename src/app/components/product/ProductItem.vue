<template>
  <section v-if='productItem' id='product-item' class='box'>
    ...
    <div class='product-item__details'>
      ...
      <button class='button is-primary product-item__button' @click='addAndGoToCart(productItem)'>
        Add to Cart
      </button>
    </div>
    <div class='product-item__image'>
      <img :src="require('../../assets/' + productItem.image_tag)" alt='product image' />
    </div>
  </section>
</template>
...
<script>
  export default {
    ...
    computed: {
      productItem() {
        return this.$store.getters.productItemFromId(+this.id)
      },
    },
    methods: {
